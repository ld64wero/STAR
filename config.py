...
path_male_star = '../input/models/star_1_1/male/model.npz'
path_female_star = '../input/models/star_1_1/female/model.npz'
path_neutral_star = '../input/models/star_1_1/neutral/model.npz'
